...
{   
    ...
    pwmSetClock( 500 );          // 74.25 MHz / 500 / 2000 = 74.25 Hz
    pwmSetRange( 2000 );
    pwmWrite( servopin, 250 );   // min 250 = 0 degree, max 750 = 180 degree
            ...
            if (client_socket[i] != NO_SOCKET && FD_ISSET(client_socket[i], &readfds)) {
                ...
                else 
                {
                    ...
                    if (strcmp(buffer, "middle") == 0) {
                        pwmWrite( servopin, 500);
                        strcpy( message2, "Middle " );
                        msg = 1;
                    } else if (strcmp(buffer, "right") == 0) {
                        pwmWrite( servopin, 250);
                        strcpy( message2, "Right " );
                        msg = 1;
                    } else if (strcmp(buffer, "left") == 0) {
                        pwmWrite( servopin, 750);
